...
private:
    ...
    void updateCameraVectors()
    {
        ...
        Right = Normalized(Cross(Front, WorldUp));  // normalize the vectors, because their length gets closer to 0 the more you look up or down which results in slower movement.
